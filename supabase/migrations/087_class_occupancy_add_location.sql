-- ============================================================
-- Migration 085: Tambah location + class_type di get_class_occupancy
-- Sebelumnya laporan Kelas hanya flat list tanpa informasi studio/lokasi.
-- Dengan tambahan dua field ini, laporan bisa di-group per studio di UI
-- tanpa RPC baru - additive terhadap 084.
-- ============================================================
